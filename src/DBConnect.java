...
public class DBConnect implements Runnable{
    ...
    private void readTag() throws SQLException {
        ...
        String SQL = "SELECT * FROM Ntregister where dato > '06.09.2015'";
        String SQLCount = "SELECT COUNT(*) FROM Ntregister where dato > '06.09.2015'";
        ...
        try {
            while (resultSet.next()) {
                ...
                produkt = resultSet.getString("Nt");
    ...
    private void writeToFile(String produkt, String tag1, String tag2, String tag3, String tag4, String tag5,
                             String tag6, String tag7, String tag8) throws IOException
    {
        teller++;
        FileWriter write = new FileWriter("c:/TrainingSetNt.arff", true);
    ...
    private void readTagLoop(Date datoSet) throws SQLException {
        ...
        //Sql spørring som henter ut produkt fra Ungernet med timestampet
        String SQL = "SELECT * FROM Ntregister where dato > '06.09.2013'";
        String SQLCount = "SELECT COUNT(*) FROM Ntregister where dato > '06.09.2013'";

        gui.txtInfoPane.append("\nAntall linjer fra NtRegistrering: " + SQLCount);
        ...
        //Henter ut data fra NtRegister spørring Ungernet
        try {
            while (resultSet.next()) {
                //System.out.println(resultSet.getString("value"));
